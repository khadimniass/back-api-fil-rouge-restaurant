...
final class Version20220705112342 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, gestionnaire_id INT DEFAULT NULL, nom VARCHAR(100) NOT NULL, etat INT DEFAULT 1 NOT NULL, description LONGTEXT NOT NULL, image LONGBLOB DEFAULT NULL, prixLivraison DOUBLE PRECISION DEFAULT NULL, quantity INT NOT NULL, role VARCHAR(255) NOT NULL, INDEX IDX_29A5EC276885AC1B (gestionnaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
